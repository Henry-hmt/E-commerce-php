    ...
    <div id="Carrossel" class="carousel slide" data-bs-ride="carousel" data-bs-interval="5000">
      ...
      <div class="carousel-inner">
        ...
        <div class="carousel-item">
          ...
          <div class="carousel-caption">
            <p class="text-center bg-dark text-light rounded-pill p-2 position-relative start-50 translate-middle-x bg-opacity-50">Melhores opções do momento</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-4 mb-4">
        <div class="card h-100 w-300 border">
          ...
          <div class="card-body">
            ...
            <a href="./Modelos_intermediarios/pagina-principal.php" class="titulo-link">Modelos intermediários</a>

            </h5>
            <p class="card-text">Celulares intermediários equilibram preço e desempenho, oferecendo bom valor para quem busca um dispositivo robusto sem gastar muito.
               Eles geralmente possuem processadores de médio desempenho, 6GB a 8GB de RAM, e armazenamento interno entre 128GB e 256GB, expansível com microSD.
                As telas variam de 6 a 6,5 polegadas com resolução Full HD+, e as câmeras são de 48MP a 108MP, com múltiplas lentes. A bateria, com capacidade de 4.000mAh a 5.000mAh,
                 garante uma autonomia razoável. Esses aparelhos rodam versões recentes do Android, combinando desempenho e custo-benefício para uso diário.</p>
          </div>
        </div>
      </div>
      <div class="col-md-4 mb-4">
